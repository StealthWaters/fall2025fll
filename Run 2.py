...
async def main():
    ...
    await runloop.sleep_ms(200)
    await turning_for_degree_v3(1350, 1, 200)
    ...
    await runloop.sleep_ms(200)
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, -200, 0, velocity=1000) #go back
    await motor_pair.move_tank_for_degrees(motor_pair.PAIR_1, -40, 150, -150) #go back
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, -600, 0, velocity=670) #go back
runloop.run(main())
