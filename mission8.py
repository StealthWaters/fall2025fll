...
async def main():
    await move_straight_for_time(310, 800)
    await motor.run_for_degrees(port.A, -145, 99999)
    for i in range(4):
        await motor.run_for_degrees(port.A, 100, 999999)
        await motor.run_for_degrees(port.A, -100, 999999)
    await move_straight_for_time(700, 800, -1)
runloop.run(main())
