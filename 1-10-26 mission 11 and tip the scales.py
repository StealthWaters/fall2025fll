...
async def main():
    ...
    await runloop.sleep_ms(350)
    await motor_pair.move_tank_for_degrees(motor_pair.PAIR_1, 30, 100, -100) #Rotate into a position where it is ready to complete tipping the scales
    await runloop.sleep_ms(350)
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, -173, 1, velocity=450)#move backwards, to set up for one way door
    await runloop.sleep_ms(350)
    ...
    await runloop.sleep_ms(350)
    await motor_pair.move_tank_for_degrees(motor_pair.PAIR_1, -135, 100, -200) #rotate to set up b4 going home
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, 600, 1, velocity=450)#move homes
    await runloop.sleep_ms(350)
    await motor_pair.move_tank_for_degrees(motor_pair.PAIR_1, -35, 100, -200) #rotate to set up b4 going home
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, 600, 1, velocity=450)#move homes
    print("ended")
