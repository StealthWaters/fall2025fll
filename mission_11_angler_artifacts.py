...
async def main():
    ...
    await runloop.sleep_ms(350)
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, 90, 1)
    ...
    await runloop.sleep_ms(350)
    await motor.run_for_degrees(port.C, 1500, 600)
    ...
    await runloop.sleep_ms(350)
    await motor_pair.move_tank_for_degrees(motor_pair.PAIR_1, 85, -100, 100)
    await sound.beep(640, 500, 100)
    await runloop.sleep_ms(350)
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, 910, 1, velocity=450)
